...
- (void)updateText {
    ...
    if (self.day<=0 && self.hour<=0 && self.minute<=0) {
        self.text = [NSString stringWithFormat:@"倒计时: %02zd", self.second];
    }else if(self.day<=0 && self.hour<=0 ){
        self.text = [NSString stringWithFormat:@"倒计时: %02zd:%02zd", self.minute, self.second];

    }else if(self.day<=0 ){
        self.text = [NSString stringWithFormat:@"倒计时：%02zd:%02zd:%02zd", self.hour, self.minute, self.second];
