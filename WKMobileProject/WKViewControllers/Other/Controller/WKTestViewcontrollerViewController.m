//
//  WKTestViewcontrollerViewController.m
//  WKMobileProject
//
...
#import "WKSecondViewController.h"
@interface WKTestViewcontrollerViewController ()

@end

@implementation WKTestViewcontrollerViewController
...
- (void)WKCustomPopViewWithOkBtnAction{
    MLLog(@"确定");
    WKSecondViewController *vc = [WKSecondViewController new];
