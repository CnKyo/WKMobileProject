...
@interface WKPayVIPTopupViewController ()<WKPayVIPTopupCellDelegate,WKWashPayResultViewDelegate>

@end

@implementation WKPayVIPTopupViewController
{
...
- (void)viewDidLoad {
    ...
    [self addTableView];
    UINib   *nib = [UINib nibWithNibName:@"WKPayVIPTopupCell" bundle:nil];
...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    WKPayVIPTopupCell *cell = [tableView dequeueReusableCellWithIdentifier:reuseCellId];
