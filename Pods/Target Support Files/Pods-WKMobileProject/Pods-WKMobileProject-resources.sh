...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "${PODS_ROOT}/AlipaySDK-2.0/AlipaySDK.bundle"
  install_resource "${PODS_ROOT}/DateTools/DateTools/DateTools/DateTools.bundle"
  install_resource "${PODS_ROOT}/IQKeyboardManager/IQKeyboardManager/Resources/IQKeyboardManager.bundle"
  install_resource "${PODS_ROOT}/MJRefresh/MJRefresh/MJRefresh.bundle"
  install_resource "${PODS_ROOT}/PSCarouselView/CarouselDemo/PSCarouselView/PSCarouselCollectionCell.xib"
